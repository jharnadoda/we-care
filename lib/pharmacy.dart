...
class HospitalData {
  ...
  getNearbyHospital() async {
    ...
    String url =
        'https://api.tomtom.com/search/2/nearbySearch/.JSON?key=$kTomsApiKey&lat=${userLocation.latitude}&lon=${userLocation.longitude}&radius=2000&limit=10&categorySet=7326';
    ...
    for (var h in hospitals) {
      ...
      String uri =
          'https://api.opencagedata.com/geocode/v1/json?q=$locationLat+$locationLon&key=c641fea5f61e4b03b6fb22c6949f9553';
      ...
      uri =
          'https://api.tomtom.com/routing/1/calculateRoute/${userLocation.latitude},${userLocation.longitude}:$locationLat,$locationLon/json?key=XjxuZEy6fiwUFFOGt0T9lcYpw1J9jWXG';
