...
import 'package:we_care/pharmacy.dart';
...
class NearbyPharmacyScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return NearbyPharmacyScreenState();
  }
}

class NearbyPharmacyScreenState extends State<NearbyPharmacyScreen> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text('Searching for pharmacies nearby..'),
                  ),
                  Text(' Please wait! '),
                ],
              ),
