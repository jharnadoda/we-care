...
class GroupChatScreen extends StatefulWidget{
  GroupChatScreen({this.name, this.chatId, this.userID});
        ...
        body: Column(
          children: [
            StreamBuilder<QuerySnapshot>(
                stream: Firestore.instance.collection('groupChats').document(widget.chatId).collection('messages')
                    ...
                    child: Padding(
                        ...
                        child: IconButton(
                          ...
                          onPressed: (){
                            ...
                            Firestore.instance.collection('groupChats').document(widget.chatId).collection('messages').add({
                              "senderId": widget.userID,
                              "message" : messageController.text,
                              "timestamp": timestamp
                            },
                            );
                            Firestore.instance.collection('groupChats').document(widget.chatId)
                                .updateData({
                              'time': time,
